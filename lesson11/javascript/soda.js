...
// ------Soda Springs Events JSON FETCH------
...
fetch(procureURL)
  ...
  .then(function (jsnObject) {
    ...
    const eventfilter = towns.filter(town => town.name === "Soda Springs");
...
const apiURL =
    "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=946ee3e55995e79e2d6f02d00a3dce79&units=imperial";
  ...
  const forecastURL =
    "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=946ee3e55995e79e2d6f02d00a3dce79&units=imperial";
